...
public class ConditionalStatement {
	...
	public static void main(String[] args) {
		...
		//성적이 60점 이상이면 "합격입니다", 60점 미만이면 "불함격입니다."를 출력
		//비교 >=:관계연산자
		...
		if(score>=60) {
			...
			System.out.println("불합격입니다."); //한줄로 묶어서 해도 문제 없음,  여기까지가 하나의 조건문(하나의 문장).
		    bad++;
		}
		...
		if(score>=80)
			...
			System.out.println("성적은 F입니다");//조건문 하나의 블록
		
		
		//0->"없음", 1->"하나", 2->"돌", 0/1/2가 아니면 "많음"을 출력
		switch(score) {
		case 0:
			System.out.println("없음");
			break;  //브레이크 대신에 영을 집어 넣을 경우 스코어가 0이면 없음과 하나 2개 다 프린트된다. 
		case 1:
